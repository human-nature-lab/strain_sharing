...
sn_vil_rel_1 <- sn_vil_1 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_2 <- sn_vil_2 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_3 <- sn_vil_3 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_4 <- sn_vil_4 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_5 <- sn_vil_5 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_6 <- sn_vil_6 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_7 <- sn_vil_7 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_8 <- sn_vil_8 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_9 <- sn_vil_9 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_10 <- sn_vil_10 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_11 <- sn_vil_11 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_12 <- sn_vil_12 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_13 <- sn_vil_13 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_14 <- sn_vil_14 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_15 <- sn_vil_15 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_16 <- sn_vil_16 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_17 <- sn_vil_17 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
sn_vil_rel_18 <- sn_vil_18 %>% filter(building_id_ego == building_id_alter) %>%
  distinct(pair_key, .keep_all = TRUE)
