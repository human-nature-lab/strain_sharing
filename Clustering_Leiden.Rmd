...
set.seed(1)
illustrative_village_sn_leiden <- as.ggplot(expression(plot(#sn_cluster,
  sn_vil,
  vertex.label = NA,
  vertex.size = 5,
  mark.col = colors,
...
set.seed(1)
illustrative_village_overlay_leiden <- as.ggplot(expression(plot(
  sn_vil,
  vertex.label = NA,
  vertex.size = 5,
  edge.color = "black",
...
illustrative_village_mbiome_leiden <- as.ggplot(expression(plot(
  mbiome_cluster,
  mbiome_all,
  col = mbiome_cols,
...
create_figure
```{r}
fig_13l <- ggarrange(illustrative_village_mbiome_leiden,illustrative_village_sn_leiden,illustrative_village_overlay_leiden,
                      labels = c("A", "B", "C"),
                      ncol = 1)
