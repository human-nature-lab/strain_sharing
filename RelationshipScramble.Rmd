...
for(i in 1:length(relationships)){
  ...
  # sn_vil_rel_scram_1 <- sn_vil_rel_1
  # sn_vil_rel_scram_2 <- sn_vil_rel_2
  # sn_vil_rel_scram_3 <- sn_vil_rel_3
  # sn_vil_rel_scram_4 <- sn_vil_rel_4
  # sn_vil_rel_scram_5 <- sn_vil_rel_5
  # sn_vil_rel_scram_6 <- sn_vil_rel_6
  # sn_vil_rel_scram_7 <- sn_vil_rel_7
  # sn_vil_rel_scram_8 <- sn_vil_rel_8
  # sn_vil_rel_scram_9 <- sn_vil_rel_9
...
svglite("../FiguresNew/SFigure1/sfigure1_full.svg")
rel_scramb_p
dev.off()
```
