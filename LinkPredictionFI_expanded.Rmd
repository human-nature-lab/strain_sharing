...
```
```{r}
#Mariposal and Carrizalito 1 do well and Quesaras
...
#Good ad predictig within cluster
E(pred_graph)$color <- pred_colors
par(mar=c(0,0,0,0)+.1)
set.seed(1993)
layout <- layout.fruchterman.reingold(pred_graph)

#svglite("../Figures/Figure3/Prediction_Network_All.svg")
...
#svglite("../Figures/Figure3/Prediction_Network_NKH.svg")
