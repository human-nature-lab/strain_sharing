...
```{r}
readr::write_tsv(Downsamp_all_stable_ties |>select(-ego,-alter), 'data/export/Downsamp_all_stable_ties.tsv')
readr::write_tsv(Downsamp_all_stable_ties_nkh |>select(-ego,-alter), 'data/export/Downsamp_all_stable_ties_nkh.tsv')
```
