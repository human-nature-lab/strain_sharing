...
# strain_cluster_1 <- cluster_louvain(strain_vil_graph_1, weights = E(strain_vil_graph_1)$weight)
# strain_cluster_2 <- cluster_louvain(strain_vil_graph_2, weights = E(strain_vil_graph_2)$weight)
# strain_cluster_3 <- cluster_louvain(strain_vil_graph_3, weights = E(strain_vil_graph_3)$weight)
# strain_cluster_4 <- cluster_louvain(strain_vil_graph_4, weights = E(strain_vil_graph_4)$weight)
# strain_cluster_5 <- cluster_louvain(strain_vil_graph_5, weights = E(strain_vil_graph_5)$weight)
# strain_cluster_6 <- cluster_louvain(strain_vil_graph_6, weights = E(strain_vil_graph_6)$weight)
# strain_cluster_7 <- cluster_louvain(strain_vil_graph_7, weights = E(strain_vil_graph_7)$weight)
# strain_cluster_8 <- cluster_louvain(strain_vil_graph_8, weights = E(strain_vil_graph_8)$weight)
# strain_cluster_9 <- cluster_louvain(strain_vil_graph_9, weights = E(strain_vil_graph_9)$weight)
...
# #Order names for both clusters
# mbiome_member_1_strain <- membership(strain_cluster_1)[match(names(membership(sn_cluster_1)),
#                                                            names(membership(strain_cluster_1)))]
# mbiome_member_2_strain <- membership(strain_cluster_2)[match(names(membership(sn_cluster_2)),
#                                                            names(membership(strain_cluster_2)))]
# mbiome_member_3_strain <- membership(strain_cluster_3)[match(names(membership(sn_cluster_3)),
#                                                            names(membership(strain_cluster_3)))]
# mbiome_member_4_strain <- membership(strain_cluster_4)[match(names(membership(sn_cluster_4)),
#                                                            names(membership(strain_cluster_4)))]
# mbiome_member_5_strain <- membership(strain_cluster_5)[match(names(membership(sn_cluster_5)),
#                                                            names(membership(strain_cluster_5)))]
# mbiome_member_6_strain <- membership(strain_cluster_6)[match(names(membership(sn_cluster_6)),
#                                                            names(membership(strain_cluster_6)))]
# mbiome_member_7_strain <- membership(strain_cluster_7)[match(names(membership(sn_cluster_7)),
#                                                            names(membership(strain_cluster_7)))]
# mbiome_member_8_strain <- membership(strain_cluster_8)[match(names(membership(sn_cluster_8)),
#                                                            names(membership(strain_cluster_8)))]
# mbiome_member_9_strain <- membership(strain_cluster_9)[match(names(membership(sn_cluster_9)),
#                                                            names(membership(strain_cluster_9)))]




#adjust village cluster numbers so the are different across villages
#never more than 100 clusters so this works
...
# mbiome_member_1_strain <- mbiome_member_1_strain + 100
# mbiome_member_2_strain <- mbiome_member_2_strain + 200
# mbiome_member_3_strain <- mbiome_member_3_strain + 300
# mbiome_member_4_strain <- mbiome_member_4_strain + 400
# mbiome_member_5_strain <- mbiome_member_5_strain + 500
# mbiome_member_6_strain <- mbiome_member_6_strain + 600
# mbiome_member_7_strain <- mbiome_member_7_strain + 700
# mbiome_member_8_strain <- mbiome_member_8_strain + 800
# mbiome_member_9_strain <- mbiome_member_9_strain + 900
...
# all_mbiome_membership_strain <-c(mbiome_member_1_strain,
#                           mbiome_member_2_strain,
#                           mbiome_member_3_strain,
#                           mbiome_member_4_strain,
#                           mbiome_member_5_strain,
#                           mbiome_member_6_strain,
#                           mbiome_member_7_strain,
#                           mbiome_member_8_strain,
#                           mbiome_member_9_strain)
...
#names align
sum(names(all_sn_membership) != names(all_mbiome_membership))
#names(all_sn_membership) == names(all_mbiome_membership_strain)
...
for(i in 1:10000){
  ...
  # strain_vil_graph_scram_1 <- set.vertex.attribute(strain_vil_graph_scram_1, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_1, "name")))
  # strain_vil_graph_scram_2 <- set.vertex.attribute(strain_vil_graph_scram_2, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_2, "name")))
  # strain_vil_graph_scram_3 <- set.vertex.attribute(strain_vil_graph_scram_3, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_3, "name")))
  # strain_vil_graph_scram_4 <- set.vertex.attribute(strain_vil_graph_scram_4, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_4, "name")))
  # strain_vil_graph_scram_5 <- set.vertex.attribute(strain_vil_graph_scram_5, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_5, "name")))
  # strain_vil_graph_scram_6 <- set.vertex.attribute(strain_vil_graph_scram_6, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_6, "name")))
  # strain_vil_graph_scram_7 <- set.vertex.attribute(strain_vil_graph_scram_7, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_7, "name")))
  # strain_vil_graph_scram_8 <- set.vertex.attribute(strain_vil_graph_scram_8, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_8, "name")))
  # strain_vil_graph_scram_9 <- set.vertex.attribute(strain_vil_graph_scram_9, "name",
  #                                                       value = sample(vertex_attr(strain_vil_graph_scram_9, "name")))
  # 
  ...
  # strain_cluster_1_scram <- cluster_louvain(strain_vil_graph_scram_1, weights = E(strain_vil_graph_scram_1)$weight)
  # strain_cluster_2_scram <- cluster_louvain(strain_vil_graph_scram_2, weights = E(strain_vil_graph_scram_2)$weight)
  # strain_cluster_3_scram <- cluster_louvain(strain_vil_graph_scram_3, weights = E(strain_vil_graph_scram_3)$weight)
  # strain_cluster_4_scram <- cluster_louvain(strain_vil_graph_scram_4, weights = E(strain_vil_graph_scram_4)$weight)
  # strain_cluster_5_scram <- cluster_louvain(strain_vil_graph_scram_5, weights = E(strain_vil_graph_scram_5)$weight)
  # strain_cluster_6_scram <- cluster_louvain(strain_vil_graph_scram_6, weights = E(strain_vil_graph_scram_6)$weight)
  # strain_cluster_7_scram <- cluster_louvain(strain_vil_graph_scram_7, weights = E(strain_vil_graph_scram_7)$weight)
  # strain_cluster_8_scram <- cluster_louvain(strain_vil_graph_scram_8, weights = E(strain_vil_graph_scram_8)$weight)
  # strain_cluster_9_scram <- cluster_louvain(strain_vil_graph_scram_9, weights = E(strain_vil_graph_scram_9)$weight)
  ...
  # mbiome_member_1_scram_strain <- membership(strain_cluster_1_scram)[match(names(membership(sn_cluster_1)),
  #                                                                        names(membership(strain_cluster_1_scram)))] + 100
  # mbiome_member_2_scram_strain <- membership(strain_cluster_2_scram)[match(names(membership(sn_cluster_2)),
  #                                                                        names(membership(strain_cluster_2_scram)))] + 200
  # mbiome_member_3_scram_strain <- membership(strain_cluster_3_scram)[match(names(membership(sn_cluster_3)),
  #                                                                        names(membership(strain_cluster_3_scram)))] + 300
  # mbiome_member_4_scram_strain <- membership(strain_cluster_4_scram)[match(names(membership(sn_cluster_4)),
  #                                                                        names(membership(strain_cluster_4_scram)))] + 400
  # mbiome_member_5_scram_strain <- membership(strain_cluster_5_scram)[match(names(membership(sn_cluster_5)),
  #                                                                        names(membership(strain_cluster_5_scram)))] + 500
  # mbiome_member_6_scram_strain <- membership(strain_cluster_6_scram)[match(names(membership(sn_cluster_6)),
  #                                                                        names(membership(strain_cluster_6_scram)))] + 600
  # mbiome_member_7_scram_strain <- membership(strain_cluster_7_scram)[match(names(membership(sn_cluster_7)),
  #                                                                        names(membership(strain_cluster_7_scram)))] + 700
  # mbiome_member_8_scram_strain <- membership(strain_cluster_8_scram)[match(names(membership(sn_cluster_8)),
  #                                                                        names(membership(strain_cluster_8_scram)))] + 800
  # mbiome_member_9_scram_strain <- membership(strain_cluster_9_scram)[match(names(membership(sn_cluster_9)),
  #                                                                        names(membership(strain_cluster_9_scram)))] + 900
  ...
  #null_rands_strain[i] <- adjustedRandIndex(all_mbiome_membership_scram_strain, all_sn_membership)
  #Check status
  #all_mbiome_membership_scram == all_mbiome_membership
  if(i %%100  == 0){
    print(i)
  }
  #Get not combined statistics
  
  #Louvain clustering does not work on bray curtids for this data
  #Is there a better way to cluster the strain data? Probably, I'm not exactly sure what
  
  if(i == 1){
    null_clusters <- data.frame(rand_inds = c(mclust::adjustedRandIndex(mbiome_member_1_scram, sn_member_1),
    ...
    null_clusters <- rbind(null_clusters,
...
village_map
village_names_temp <- unname(village_map[village_names])
observed <- data.frame(
...
null_clusters$vils <- unname(village_map[null_clusters$vils])
...
cluster_pvals_fig <- ggplot(null_clusters, aes(x=rand_inds ))+
