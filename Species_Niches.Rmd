...
```{r}
vil_graph <- sn_vil_graph_15
#Get species
species_for_niche <- unlist(species_data["k__Bacteria|p__Firmicutes|c__Bacilli|o__Lactobacillales|f__Enterococcaceae|g__Enterococcus|s__Enterococcus_faecium|t__SGB7967",])
#Get village clusters
clusters <- sn_member_15
...
plot(
  vil_graph,
  vertex.size = log2(ordered_species*100000+5)+2,
  vertex.label = NA
)
...
vil_graph <- sn_vil_graph_15
#Get species
species_for_niche <- unlist(species_data["k__Bacteria|p__Actinobacteria|c__Coriobacteriia|o__Coriobacteriales|f__Coriobacteriaceae|g__GGB9379|s__GGB9379_SGB14372|t__SGB14372",])
#Get village clusters
clusters <- sn_member_15
#Filter species to village members
ordered_species <-
